...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FGenSchemaResponseDelegate, const FString&, Response, const FString&,
											   Error, bool, Success);
...
class GENERATIVEAISUPPORT_API UGenOAIStructuredOpService : public UCancellableAsyncAction
{
  ...
  public:
	...
	static void RequestStructuredOutput(const FGenOAIStructuredChatSettings& StructuredChatSettings,
	...
	UFUNCTION(BlueprintCallable, meta = (BlueprintInternalUseOnly = "true", WorldContext = "WorldContextObject"),
			  Category = "GenAI")
	static UGenOAIStructuredOpService*
	RequestOpenAIStructuredOutput(UObject* WorldContextObject,
  ...
  private:
	...
	static void MakeRequest(const FGenOAIStructuredChatSettings& StructuredChatSettings,
