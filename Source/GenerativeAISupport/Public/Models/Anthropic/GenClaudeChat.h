...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FGenClaudeChatCompletionDelegate, const FString&, Response,
...
class GENERATIVEAISUPPORT_API UGenClaudeChat : public UCancellableAsyncAction
{
  ...
  public:
	...
	static void SendChatRequest(const FGenClaudeChatSettings& ChatSettings,
  ...
  private:
	...
	static void MakeRequest(const FGenClaudeChatSettings& ChatSettings,
